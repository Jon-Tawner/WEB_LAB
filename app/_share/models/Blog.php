...
class Blog extends BaseActiveRecord {
    ...
    function __construct() {
        ...
        $this->tableComments = new CommentsBlog;
    }
    ...
    public function getDataBlog() {
        return $this->find($_POST['id']);
    }

    public function getComments() {
        return $this->tableComments->getComments($_POST['blogId']);
    }

    public function saveComment() {
        $this->tableComments->saveComment($_SESSION['user']['name'], $_POST['content'], $_POST['blogId']);
    }
}
